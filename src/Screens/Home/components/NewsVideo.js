...
const NewsVideo = ({ data }) => {
    return (
        <>
            <h6 className='mx-auto w-[77.5%] pt-2 font-bold bbc'>News Video</h6>
                    ...
                    {data.map((nv) => {
                        return (
                            <>
                                <div className=''>
                                    <div className=''>
                                        <div><img className='h-[20px] w-[20px] float-left mr-2' src={BbcImage.PlayButton} alt="" /></div>
                                        <div className='font-bold xs:line-clamp-1 bbc'>Watch {nv?.title}</div>
                                    </div>
